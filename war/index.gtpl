...
<html>
    ...
    <body>
        ...
        <section id="main">
			...
			<p>
				Simply use a URL in the format <code>${request.scheme}://${request.serverName}/<em>width</em>/<em>height</em></code>, (<em>e.g.</em> <code><a href="/480/320">${request.scheme}://${request.serverName}/480/320</a></code>) to get a placeholder image.
			</p>
        </section>
